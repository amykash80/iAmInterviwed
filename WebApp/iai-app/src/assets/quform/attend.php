...
/**
 * Configure the inquiry element
 * Filters: Trim
 * Validators: Required
 */
$inquiry = new Quform_Element('inquiry', 'Number of Guest');
$inquiry->addFilter('trim');
$inquiry->addValidator('required');
$form->addElement($inquiry);
 ...
 * Validators: Required
 */
$radioButton2 = new Quform_Element('radio_button2', 'Are you coming!');
